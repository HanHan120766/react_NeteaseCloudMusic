...
module.exports = {
  ...
  devServer: {
    ...
    proxy: [{
      context: ["/login", "/user","/top","/songDetail","/playlist","/music","/search","/lyric","/comment","/banner","/song","/program","/album","/artists","/simi","/recommend","/personal_fm","/daily_signin","/like","/fm_trash","/mv","/personalized","/dj"],
